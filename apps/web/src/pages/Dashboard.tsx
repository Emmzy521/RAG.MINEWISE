  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">View analytics and system statistics</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.queryCount || 0}</div>
            <p className="text-xs text-muted-foreground">Total queries executed</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Total indexed chunks</p>
          </CardContent>
        </Card>
      </div>
    </div>
